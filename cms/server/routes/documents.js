...
router.get('/', (req, res, next) => {
 ...
 //This method is called whenever an HTTP POST request is sent on the /documents route.
 router.post('/', (req, res, next) => {
  ...
  // This method is responsible for updating an existing document in the database
